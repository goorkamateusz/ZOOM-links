...
<body>
    <div class="menu">
        <span class="switch" id="future">
            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="48px" height="24px" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" viewBox="0 0 4800 2400" xmlns:xlink="http://www.w3.org/1999/xlink">
                <defs>
                    <style type="text/css">
                        <![CDATA[
                        .str0 {
    ...
    <main>
        ...
        // Konwertuje z stdClass na Invitation class
        function conv($a)
        {
            return new Invitation($a);
        }
        ...
        ?>
            <?php
            // Ustawienie klasy: dzisiaj, minęło, przyszłość
            $class = "future";
